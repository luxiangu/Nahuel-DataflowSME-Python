...
class WindowedTeamScore (PTransform):
    ...
    def expand(self, input):
        ...
        return (input
                ...
                # applies windowing to the PCollection.
                # FixedWindows() returns a WindowFn that assigns elements to windows
                # of a fixed number of milliseconds. Use
                # these methods to apply fixed windows of size
                # self.duration to the PCollection.
                | ChangeMe()
                ...
                # scores (recall it is a public function of exercise1).
                | ChangeMe()
                # [END EXERCISE 2]
                )
...
class ExtractAndSumScore(PTransform):
    ...
    Implement a series of PTransforms that take a PCollection of events
       ...
       This is the same code you implemented in Exercise 1
    """
